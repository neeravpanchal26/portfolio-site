      ...
      <div id="top">
        ...
        <ul className="sidenav" id="sideNav">
          ...
          <li>
            <NavLink to="/">
              <i>
                <MdHome className="black-text" id="Icon" />
              </i>
              Home
            </NavLink>
          </li>
          <li>
            <NavLink to="/about">
              <i>
                <MdInfo className="black-text" id="Icon" />
              </i>
              About
            </NavLink>
          </li>
          <li>
            <NavLink to="/timeline">
              <i>
                <MdTimeline className="black-text" id="Icon" />
              </i>
              Timeline
            </NavLink>
          </li>
          <li>
            <NavLink to="/portfolio">
              <i>
                <MdWork className="black-text" id="Icon" />
              </i>
              Portfolio
            </NavLink>
          </li>
          <li>
            <NavLink to="/contact">
              <i>
                <MdPhone className="black-text" id="Icon" />
              </i>
              Contact
            </NavLink>
          </li>
